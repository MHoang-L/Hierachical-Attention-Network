...
def read_data(data_file):
  data = pd.read_csv(data_file, sep=',', header=None, usecols=[0, 1])
  print('{}, shape={}'.format(data_file, data.shape))
  return data

if __name__ == '__main__':
  # Read the training data
  train_data = read_data('data/yelp-2015-train.csv')
  ...
  word_to_index = build_vocab(train_data[1], 'data/yelp-2015')
  ...
  test_data = read_data('data/yelp-2015-test.csv')
